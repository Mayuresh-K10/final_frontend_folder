...
const MoreNews = [
  {
    ...
    content:
      "New Delhi: Prime Minister, Narendra Modi inaugurated a medical college in the town of Silvassa and l...",
    read_link: "Read More",
  },
  {
    ...
    content:
      "New Delhi: Indian Institute of Management (IIM) Kozhikode held an orientation ceremony for students",
    read_link: "Read More",
  },
  {
  ...
  },
  {
    ...
    date: "Apr 26, 2023",
    heading:
      "IIM Bangalore Admission 2023: Fees, Cutoff, Selection Criteria, Eligibility",
    content:
      "IIM Bangalore MBA admission for 2023-25 batch is currently going on. IIM Bangalore WAT-PI round ha...",
    read_link: "Read More",
  },
  {
    ...
    content:
      "New Delhi: As per the latest updates, the Birla Institute of Technology and Science (BITS) Pilani ha... ",
    read_link: "Read More",
  },
  {
    ...
    date: "Apr 26, 2023",
    heading:
      "DTU Admission 2023: Courses, Eligibility, Application Process, Last Date To Apply",
    content:
      "DTU admission 2023&nbsp;is based on various national-level and university-based entrance examinati... ",
    read_link: "Read More",
  },
  {
    ...
    date: "Apr 26, 2023",
    heading:
      "Thakur Global Business School Admission 2023: Eligibility, Process, Fees, Dates",
    content:
      "Thakur Global Business School (TGBS), Mumbai offers a PGDM program under the discipline of Marketi...",
    read_link: "Read More",
  },
  {
    ...
    date: "Apr 26, 2023",
    heading:
      "Echelon Institute of Technology Admission 2023: Courses, Fees, Eligibility and Regist...",
    content:
      "Echelon Institute of Technology (EIT) is located in Faridabad and affiliated to the YMCA Universit... ",
    read_link: "Read More",
  },
  {
    ...
    date: "Apr 26, 2023",
    heading:
      "NSIT (NSUT) Admission 2023: Cutoff, Dates, Courses, Eligibility, Application Process",
    content:
      "NSIT Delhi admissions are done on the basis of national-level exams followed by a counselling pr...",
    read_link: "Read More",
  },
];
