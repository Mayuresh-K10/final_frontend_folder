...
const Profile = () => {
    ...
    // Retrieve if already saved in storage
        ...
        const fetchResumeData = async () => {
            ...
            try {
                const response = await axios.get(
                    `${process.env.REACT_APP_BACKEND_DJANGO_URL}/jobseeker_resume/${userid}/`,
                    {
                ...
                setSkills(data.skills ? data.skills.toString() : "");
    ...
    const handleSaveProfile = async () => {
        ...
        try {
            ...
            const response = await axios.post(
                `${process.env.REACT_APP_BACKEND_DJANGO_URL}/create-jobseeker-resume/${id}/`,
                formData,
                {
                    headers: {
            ...
            setResumeId(resume_id); // Update local state
            ...
            alert(`Error saving profile:  All feilds are required`);
        }
    };
