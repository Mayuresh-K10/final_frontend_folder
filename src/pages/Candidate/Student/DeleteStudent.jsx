...
const DeleteStudent = ({ onClose }) => {
    ...
    const companyuser = useSelector((state) => state.newuser);

    const companytoken =
        companyuser?.unique_token || localStorage.getItem("newaccessToken");
    ...
    const deleteAccount = async () => {
        try {
            ...
            await axios.post(
                `${process.env.REACT_APP_BACKEND_DJANGO_URL}/user/delete-account/`, // Adjust your endpoint as needed
