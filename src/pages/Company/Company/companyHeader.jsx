...
import CompanyNotificationComponent from "../CompanyNotificationComponent";

const CompanyHeader = ({ isCompany }) => {
    ...
    const links = CompanyDashboardLink; // Dynamically choose the links
    ...
    return (
      ...
      */}
                    <CompanyNotificationComponent token={companytoken} />
