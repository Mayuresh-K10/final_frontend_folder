...
const CollegeNotificationComponent = ({ token }) => {
    ...
    useEffect(() => {
        ...
        const ws = new WebSocket(
            `${process.env.REACT_APP_WS_BACKEND_URL}/ws/message-notifications/${collegeemail}/`
        );
...
export default CollegeNotificationComponent;
