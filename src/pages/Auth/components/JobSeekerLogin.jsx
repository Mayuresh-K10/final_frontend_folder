...
import { jobseekerloginUser } from "../../../appStore/JobseekerSlice";
...
const JobSeekerLoginCard = () => {
    ...
    const handleLogin = (e) => {
        e.preventDefault();
        dispatch(jobseekerloginUser({ email, password }));
    };
    ...
    useEffect(() => {
        if (isAuthenticated) {
            navigate("/job-portal/dashboard/candidate-dashboard/");
        }
...
export default JobSeekerLoginCard;
