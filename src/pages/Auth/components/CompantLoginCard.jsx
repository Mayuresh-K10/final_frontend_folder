...
import { companyloginUser } from "../../../appStore/CompanySlice";
...
const CompanyLoginCard = () => {
    ...
    const handleLogin = (e) => {
        e.preventDefault();
        dispatch(companyloginUser({ official_email: email, password }));
    };
    ...
    useEffect(() => {
        if (isAuthenticated) {
            navigate("/job-portal/dashboard/company-dashboard/");
        }
...
export default CompanyLoginCard;
