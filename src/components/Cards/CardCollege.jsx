...
const CardCollege = (props) => {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src={props.img ? `${process.env.REACT_APP_BACKEND_SERVER_URL}${props.img}` : defaultImage}  // Make sure `defaultImage` is defined
          alt={props.name || "College Image"}
          style={{
            height: "100px",
            width: "100px",
